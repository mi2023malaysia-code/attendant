...
import { getAdminWebinar } from '@/lib/admin/webinars';
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-2">
            ...
            <p className="max-w-3xl text-sm leading-7 text-slate-300">
              Update the webinar metadata here. The form talks directly to
              Supabase, so these changes flow into the database-backed authoring
              view immediately.
            </p>
          </div>
          <Link
